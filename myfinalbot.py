...
TOKEN = '6966678179:AAEEQZY1f3NpLrrYnS-PUYC_xbqZatKyvkQ'
...
def start_quest(message):
    global user_data
    if str(message.chat.id) in user_data and user_data[str(message.chat.id)] not in ['find_path', 'approach_waterfall', 'explore_cave', 'talk_to_villagers']:
